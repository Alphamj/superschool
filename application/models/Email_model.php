...
class Email_model extends CI_Model {
	...
	function password_reset_email($new_password = '' , $account_type = '' , $email = '')
	{
		...
		if($query->num_rows() > 0)
		{
			...
			$email_msg	.=	"Your e-mail is : ".$email."<br />";
	...
	function do_email($msg=NULL, $sub=NULL, $to=NULL, $from=NULL)
	{
		...
		$msg	=	$msg."<br /><br /><br /><br /><br /><br /><br /><hr />This is an automated mail. Do not reply<br />For further asssistance please send us a mail admin@thehillsidesclool.com";
