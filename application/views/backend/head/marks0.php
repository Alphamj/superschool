...
td {font-family: Arial, sans-serif;font-size: 12px;padding: 8px;border: 1px solid #E6E9ED;border-width: 1px;overflow: hidden;word-break: normal;color: #000;}
 ...
 <div class="x_panel tablu" >
            ...
            <div class="tab-pane  <?php if(!isset($edit_data) && !isset($personal_profile) && !isset($academic_result) )echo 'active';?>" id="list">
				<center>
                <?php echo form_open(base_url() . 'index.php?head/manage_marks0');?>
...
<!-- change link -->	<?php echo form_open(base_url() . 'index.php?head/marks0/' . $exam_id . '/' . $class_id);?>
							...
							?>
								...
								?>
											<tr>
												...
												<td width="15%">
													<select  class="class_score form-control"  name="remarks_<?php echo $rows['strand_id'];?>" readonly="true">
		...
		<table cellpadding="0" cellspacing="0" border="0" class="tg" style="width:auto">
		  ...
		  <tbody>
			  <tr>
				  ...
				  <th><span>Exceeding</span>Expectation</th>
  ...
  <?php } else if (strpos($class_type, 'nursery 1') !== false) {?>
	  ...
	  <table cellpadding="0" cellspacing="0" border="0" class="tg" style="width:auto">
		  ...
		  <tbody>
			  ...
			  <tr>
				  <td colspan="12"><span>CROSS MOTOR SKILLS</span></td>
  ...
  function exam_score_change() {
	...
	function ca_2(sub_id){
		...
		if (values > 10) {
			$("#ca_2_"+sub_id).val(0);
			 $('#error_message').show();
			$('#error_message').html('<strong style="color:#FF0000">CA2 score must be less than or equal to 10.  </strong>');
		}else{
			var ca1 = $("#ca_1_"+sub_id).val();
			var ca2 = $("#ca_2_"+sub_id).val();
			var totl = parseFloat(ca1)+parseFloat(ca2);
