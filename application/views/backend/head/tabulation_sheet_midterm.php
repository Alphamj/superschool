...
td h5 {color: #000 !important;}
 ...
 <div class="x_panel tablu" >
		...
		<?php 
			...
			echo form_open(base_url() . 'index.php?head/tabulation_sheet_midterm');?>
			<div class="col-md-3">
...
<div class="row">
	...
	<!-- Nursery-->
		...
		<center>
			<a href="<?php echo base_url();?>index.php?head/tabulation_sheet_midterm_print_view_control/<?php echo $class_id;?>/<?php echo $exam_id;?>/<?php echo $sessoin_id;?>" 
				class="btn btn-orange btn-sm btn-icon icon-left" target="_blank">
				<i class="entypo-print"></i><?php echo get_phrase('mass_report_card');?>
			</a>
			<a href="<?php echo base_url();?>index.php?head/tabulation_sheet_midterm_print_single_control/<?php echo $class_id;?>/<?php echo $exam_id;?>/<?php echo $sessoin_id;?>/<?php echo $student_id;?>" 
				class="btn btn-orange btn-sm btn-icon icon-left" target="_blank">
	  ...
	  var session_year = $("#session_year").val();
		if(current_session == session_year){
			if(class_id && session_year){
				$.ajax({
					url: '<?php echo base_url();?>index.php?head/student_session_year/' + session_year +'/'+class_id+'/current',
			...
			if(class_id && session_year){
				$.ajax({
					url: '<?php echo base_url();?>index.php?head/student_session_year/' + session_year +'/'+class_id,
					success: function(response){
						if($.trim(response)){
							$("#student_id_0").html(response);
						}else{
