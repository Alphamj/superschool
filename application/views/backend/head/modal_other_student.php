...
<table class="table">
					...
					foreach ($classes as $row):
                        ...
                        <tr>
							...
							<a href="<?php echo base_url(); ?>index.php?head/student_information/<?php echo $row['class_id']; ?>"><button type="button" class="btn btn-orange btn-xs"><i class="entypo-users"></i>View Students</button></a>
