<div class="x_panel" >
		...
		<?php echo form_open(base_url() . 'index.php?head/academic_syllabus');?>
       ...
       <table class="table table-bordered responsive" id="table_export">
						...
						?>
							<tr>
								...
								<td align="center">
									<a href="<?php echo base_url();?>index.php?head/download_academic_syllabus/<?php echo $row['academic_syllabus_code'];?>"
