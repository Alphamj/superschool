...
td {font-family: Arial, sans-serif;font-size: 12px;padding: 8px;border: 1px solid #E6E9ED;border-width: 1px;overflow: hidden;word-break: normal;color: #000;}
 ...
 <div class="x_panel tablu" >
		...
		<?php 
			...
			echo form_open(base_url() . 'index.php?head/tabulation_sheet');?>
			<div class="col-md-3">
...
<!-- Nursery -->
		...
		<?php } ?>
		<center>
			<!-- <a href="<?php //echo base_url();?>index.php?head/tabulation_sheet_print_view_control/<?php //echo $class_id;?>/<?php //echo $exam_id;?>/<?php //echo $sessoin_id;?>" 
				class="btn btn-orange btn-sm btn-icon icon-left" target="_blank">
				<i class="entypo-print"></i><?php //echo get_phrase('mass_report_card');?>
			</a> -->
			<a href="<?php echo base_url();?>index.php?head/tabulation_sheet_print_single_control/<?php echo $class_id;?>/<?php echo $exam_id;?>/<?php echo $sessoin_id;?>/<?php echo $student_id;?>" 
				class="btn btn-orange btn-sm btn-icon icon-left" target="_blank">
