...
<div class="x_panel" >        
                <div class="x_title">
                    ...
                    foreach($edit_data as $row):
                        ?>
                        <?php echo form_open(base_url() . 'index.php?head/manage_profile/update_profile_info' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
