...
<div class="row">
  <div class="x_title">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table">
		...
		<tbody>
        	<form method="post" action="<?php echo base_url();?>index.php?head/attendance_selector" class="form">
            	<tr class="gradeA">
                    <td>
...
<div class="col-md-12">
        ...
        <div class="x_panel" >
        <form action="<?php echo base_url();?>index.php?head/manage_attendance/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id;?>" method="post" accept-charset="utf-8">
