		 ...
		 <div class="x_panel" >
            ...
            <div class="x_title">
                <div class="panel-title">
                    <?php echo get_phrase('send_student_score_by_sms'); ?>
                </div>
            </div>
    	<!------CONTROL TABS END------>
			...
			<?php echo form_open(base_url() . 'index.php?admin/exam_marks_sms/send_sms' , array('target'=>'_top'));?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-3">
		<button type="submit" class="btn btn-green btn-sm btn-icon icon-left"> <i class="entypo-phone"></i><?php echo get_phrase('send_marks');?></button>
                  </div>
