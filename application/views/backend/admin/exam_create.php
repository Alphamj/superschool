...
<div class="x_panel" >
            ...
            <div class="x_title">
                <div class="panel-title">
                    <?php echo get_phrase('questions_bank'); ?>
                </div>
            </div>
...
<div class="box-content">
    ...
    <div class="padded">
        ...
        <div class="answers-group">
            <div class="form-group answers">
                ...
                <div class="col-sm-1">
                <a href="#" style="line-height: 25px;"  class="btn btn-xs btn-green btn-icon icon-left" onclick="addRemoveAnswer(this)" ><i class="entypo-plus"></i><?php echo get_phrase('add'); ?></a>
                </div>
            </div>
        </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-3 col-sm-5">
            <button class="btn btn-orange btn-sm btn-icon icon-left"><i class="entypo-right"></i><?php echo get_phrase('Next_Question'); ?></button>
        </div>
    </div>
	<hr>
</form>                
