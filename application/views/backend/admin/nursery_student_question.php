<div class="col-md-5">
 ...
 <!----CREATION FORM STARTS---->
                	...
                	<?php 
						...
						echo form_open(base_url() . 'index.php?admin/nursery_student_question/' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
 ...
 <div class="x_panel table-responsive">
                ...
                <table class="table" id="table_export">
                    ...
                    <tbody>
					 ...
					 <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/nursery_student_question/delete/<?php echo $row['question_id'];?>')"><button type="button" class="btn btn-red btn-xs"><i class="entypo-trash"></i></button></a>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function($)
	{
		$("#class_id").change(function(){
			...
			if(class_id){
				$.ajax({
					url: '<?php echo base_url();?>index.php?admin/nursery_subjects/'+class_id,
