...
<div class="x_panel" >
            ...
            <div class="x_title">
                <div class="panel-title">
                    <?php echo get_phrase('librarian_ID_card'); ?>
                </div>
            </div>
    ...
    <div class="col-md-11">
            ...
            <?php echo form_open(base_url() . 'index.php?admin/id_card/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Select a librarian</label>
                        <select name="librarian" id="librarian_id" class="form-control" style="width: 250px;">
                            <option value=""><?php echo get_phrase('select');?></option>
                            <?php 
                            $librarians = $this->db->get('librarian')->result_array();
                            foreach($librarians as $row):
                            ?>
                                <option value="<?php echo $row['librarian_id'];?>" <?php if ($librarian_id == $row['librarian_id']) echo 'selected';?>>
                                        <?php echo $row['name'];?>
                                </option>
                            <?php
                            endforeach;
                        ...
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <center>
                                <label>Image for librarian's Signature </label>
                                <span class="btn btn-xs btn-file" style="background-color: #DDD;margin-left: 38px;">
                                    <span class="fileinput-new">Upload</span>
                                    <span class="fileinput-exists">Change</span>
                                    <input type="file" name="userfile" accept="image/*" onChange="readURL_librarian(this);">
                                </span>
                            </center>
                        </div>
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                        ...
                        <!-- </div> -->
                        <!-- <input type='file' onchange="readURL(this);" value="Image for librarian's Signature" /> -->
                        <!-- <div class="row">
                            <div class="col-md-4">
                ...
                <div class="col-md-2">
                    ...
                    <button type="submit" class="btn btn-green btn-sm btn-icon icon-left"><i class="entypo-plus"></i><?php echo get_phrase('Submit');?></button>
        ...
        <div id="html-content-holder" class="area" style="background-color: #fff;">
            <div class="side">
                ...
                <div class="detail-content" style="width: 300px;height: 26px;font-size: 12px;">
                    <div style="float: left;padding-right: 6px;"><label>Phone :</label></div>
                    <div style="float: left;padding-right: 6px;"><p>+91 90325 81559</p></div>
                    <div style="float: left;padding-right: 6px;"><label>Valid Till :</label></div>
                ...
                <div class="detail-content" style="width: 320px;height: 20px;font-size: 12px;">
                    <div style="padding-right: 7px;height: 30px;">
                        <label>librarian's signature :</label>
                        <img id="librarian_sign" src="uploads/sign.png" alt="" style="margin-top: -2px;" />
                    </div>
                    <div style="padding-right: 7px;height: 30px;">
	...
	<button type="submit" id="myBtn" class="btn btn-orange btn-sm btn-icon icon-left"> <i class="entypo-plus"></i><?php echo get_phrase('preview');?></button>
...
var times = 1;
$('#librarian_id').on('click', function(){
    show_photo();
});
...
function show_photo() {
    if (times) {
        var select = $('#librarian_id');
        var value = select[0].value;
        var photo = document.getElementById("photo");
        photo.src = "uploads/librarian_image/"+value+".jpg";
        times = -1;
    }
    times++;
}
...
function readURL_librarian(input) {
