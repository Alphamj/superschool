...
<div class="x_panel" >
                ...
                <div class="x_title">
                    <div class="panel-title">
					 ...
					 <?php echo form_open(base_url() . 'index.php?admin/expense');?>
    ...
    <tbody>
        ...
        <tr>
			...
			<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/expense_edit/<?php echo $row['payment_id'];?>');"><button type="button" class="btn btn-blue btn-xs"><i class="entypo-pencil"></i></button></a>
					...
					<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/expense/delete/<?php echo $row['payment_id'];?>');"><button type="button" class="btn btn-red btn-xs"><i class="entypo-trash"></i></button></a>
