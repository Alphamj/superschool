...
<table class="table" id="table-2">
                    ...
                    <tbody>
					 ...
					 <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?librarian/book/delete/<?php echo $row['book_id'];?>');"><button type="button" class="btn btn-red btn-xs"><i class="entypo-trash"></i></button></a>
