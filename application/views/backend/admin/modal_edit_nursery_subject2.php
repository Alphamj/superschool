<!--NURSERY 3-->
<?php 
$edit_data		=	$this->db->get_where('nnursery_subject2' , array('nursub_id' => $param2) )->result_array();
...
?>
	<div class="col-md-12">
		...
		<div class="panel-body">
            <?php echo form_open(base_url() . 'index.php?admin/nursery_subject2/do_update/'.$row['nursub_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
