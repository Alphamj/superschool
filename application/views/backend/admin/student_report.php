<div class="x_panel" >
		...
		<?php echo form_open(base_url() . 'index.php?admin/student_report');?>
					 ...
					 <a href="<?php echo base_url(); ?>index.php?admin/manage_report"><button type="button" class="btn btn-orange btn-sm btn-icon icon-left"><i class="entypo-left"></i><?php echo get_phrase('back');?></button></a>
                        ...
                        <div class="col-sm-12">
                            <select name="class_id" class="form-control select2" onchange='this.form.submit()'>
...
<noscript><button type="submit" class="btn btn-green btn-sm btn-icon icon-left"><i class="entypo-search"></i><?php echo get_phrase('find');?></button></noscript>
