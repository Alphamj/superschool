...
table, tr, td, th {    border: 1px solid #000;border-collapse: collapse;font-family: sans-serif;font-size: 14px;}
				...
				.text-transform { text-align: center;g-origin: 50% 50%;-ms-transform:skew(-90deg,0deg);-moz-transform:skew(-90deg,0deg);-webkit-transform:skew(-90deg,0deg);
			-o-transform:skew(-90deg,0deg);transform:skew(-90deg,0deg); width: 60px; max-width: 60px;}

.table-header-rotated th.row-header{font-family: Arial, sans-serif;font-size: 12px; width: auto;}
			.table-header-rotated td{font-family: Arial, sans-serif;font-size: 12px;width: 40px;border-top: 1px solid #dddddd;border-left: 1px solid #dddddd;border-right: 1px solid #dddddd;vertical-align: middle;text-align: center}
			.table-header-rotated th.rotate-45{font-family: Arial, sans-serif;font-size: 12px;height: 80px;width: 40px;min-width: 40px;max-width: 40px;position: relative;vertical-align: bottom;padding: 0;font-size: 12px;line-height: 0.8;}
			.table-header-rotated th.rotate-45 > div{font-family: Arial, sans-serif;font-size: 12px;position: relative;top: 0px;left: 40px; /* 80 * tan(45) / 2 = 40 where 80 is the height on the cell and 45 is the transform angle*/
			height: 100%;-ms-transform:skew(-45deg,0deg);-moz-transform:skew(-45deg,0deg);-webkit-transform:skew(-45deg,0deg);
			-o-transform:skew(-45deg,0deg);transform:skew(-45deg,0deg);overflow: hidden;border-left: 1px solid #dddddd;border-right: 1px 
			solid #dddddd;border-top: 1px solid #dddddd;}
			.table-header-rotated th.rotate-45 span {-ms-transform:skew(45deg,0deg) rotate(315deg);-moz-transform:skew(45deg,0deg) rotate(315deg);-webkit-transform:skew(45deg,0deg) rotate(315deg);-o-transform:skew(45deg,0deg) rotate(315deg);transform:skew(45deg,0deg) rotate(315deg);position: absolute;
...
<!-- change link -->	<?php echo form_open(base_url() . 'index.php?admin/marks/' . $exam_id . '/' . $class_id);?>
...
<table cellpadding="0" cellspacing="0" border="0" class="tg">
		<?php 
			...
			<tbody>
				...
				<tr>
					<td colspan="12"><span>LANGUAGE ART</span></td>
					<td></td>
					<td></td>
					<td></td>
					<td></td>
					<td colspan="12"><span>SOCIAL-EMOTIONAL DEVELOPMENT</span></td>
					<td></td>
					<td></td>
					<td></td>
					<td></td>
					<td colspan="12"><span>KNOWLEDGE AND UNDERSTANDING<br /> OF THE WORLD</span></td>
					<td></td>
					<td></td>
					<td></td>
					<td></td>
...
<style>table, tr, td, th {    border: 1px solid #000;border-collapse: collapse;font-family: sans-serif;font-size: 14px;}
			td, th { padding: 0px;}td span {font-size: 12px;}
			.text-transform span {float: left; width: 100%; margin: 0 0 0 -22px; padding: 0 0 0 0; white-space: nowrap;}
			.text-transform { text-align: center;g-origin: 50% 50%;-webkit-transform: rotate(90deg); -moz-transform: rotate(90deg);  -ms-transform: rotate(90deg);  -o-transform: rotate(90deg); transform: rotate(270deg); height: 200px; width: 60; max-width: 80px;}
			td.inner {padding: 0;}
			td.inner table {width: 100%;}
			td.inner table, td.inner tr {border: 0;}
		</style>
