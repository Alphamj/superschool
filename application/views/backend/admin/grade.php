...
<div class="x_panel" >
 <div class="x_title">
                    <div class="panel-title">
					 <?php echo get_phrase('add_grades'); ?>
					</div>
					</div>
...
<div class="x_panel table-responsive" >
                ...
                <div class="x_title">
                    <div class="panel-title">
					 <?php echo get_phrase('list_grades'); ?>
					</div>
					</div>
                ...
                <table class="table " id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td>
							<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_grade/<?php echo $row['grade_id'];?>');"><button type="button" class="btn btn-blue btn-xs"><i class="entypo-pencil"></i></button></a>
				
                   
		<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/grade/delete/<?php echo $row['grade_id'];?>');"><button type="button" class="btn btn-red btn-xs"><i class="entypo-trash"></i></button></a>
