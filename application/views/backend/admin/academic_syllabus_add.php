...
<div class="form-group">
				...
				<div class="form-group">
                    <label for="field-2" class="col-sm-2 control-label"><?php echo get_phrase('subject'); ?></label>
		                    <div class="col-sm-10">
               ...
               <div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<button type="submit" class="btn btn-orange btn-sm btn-icon icon-left"><i class="entypo-plus"></i><?php echo get_phrase('save');?></button>
						</div>
					</div>
                <?php echo form_close(); ?>
    </div>
