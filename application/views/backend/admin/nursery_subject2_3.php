<div class="col-md-3">
 	<div class="x_panel" >
 		...
 		<!----CREATION FORM STARTS (FOR NURSERY 3)---->
          ...
          <?php echo form_open(base_url() . 'index.php?admin/nursery_subject2_3/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
...
<div class="col-md-9">
 	<div class="x_panel table-responsive">
		...
		<table class="table" id="table_export">
               ...
               <tbody>
				<?php
				$query = $this->db->get('nnursery_subject2_3')->result_array();
				foreach($query as $row):?>
						...
						<td>
							<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_nursery_subject2_3/<?php echo $row['nursub_id'];?>');"><button type="button" class="btn btn-blue btn-xs"><i class="entypo-pencil"></i></button></a>
							<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/nursery_subject2_3/delete/<?php echo $row['nursub_id'];?>');"><button type="button" class="btn btn-red btn-xs"><i class="entypo-trash"></i></button></a>
						</td>
                    	</tr>
                    <?php endforeach;?>
               </tbody>
