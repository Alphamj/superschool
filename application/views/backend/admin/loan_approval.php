 <div class="x_panel" >
                ...
                <div class="x_title">
                    <div class="panel-title">
					 <?php echo get_phrase('list_loans'); ?>
					</div>
					</div>
    ...
    <tbody>
        <?php 
			...
			<span class="label label-<?php if($row['status']=='Approved')echo 'success'; elseif ($row['status']=='Disapproved') echo 'danger'; else echo 'warning';?>"><?php echo $row['status'];?></span>
                ...
                <td>
<a href="<?php echo base_url().'uploads/loan_applicant/'.$row['file_name']; ?>"><button type="button" class="btn btn-orange btn-xs"><i class="entypo-download"></i></button></a>

                   
                </td>
                <td>
				 <a  onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_loan_edit/<?php echo $row['loan_id']?>');" ><button type="button" class="btn btn-blue btn-xs"><i class="entypo-pencil"></i></button></a>
				
                   
					 <a href="<?php echo base_url();?>index.php?admin/loan_approval/delete/<?php echo $row['loan_id']?>"><button type="button" class="btn btn-red btn-xs" onclick="return confirm('Are you sure to delete?');"><i class="entypo-trash"></i></button></a>
