...
foreach ($edit_data as $row):
    ...
    <?php echo form_open(base_url() . 'index.php?admin/message/send_new/', array('class' => 'form', 'enctype' => 'multipart/form-data')); ?>
				   ...
				   <div align="center">
		<img src="<?php echo $this->crud_model->get_image_url('hostel' , $row['hostel_id']);?>" class="img-circle" width="100" height="100" />
		</div>
		<br>

                    <div class="form-group">
                        <label for="field-1" class="col-sm-2 control-label"><?php echo get_phrase('hostel_name'); ?></label>

                        <div class="col-sm-10">
      					<input type="hidden" class="form-control" name="reciever"  value="hostel-<?php echo $row['hostel_id']; ?>" readonly="true">
					...
					<div class="col-sm-10">
					<textarea name="message" class="form-control" id="optimum-editor" placeholder= "Please type your new message here for the selected hostel to read."></textarea>
						</div>
						</div>
