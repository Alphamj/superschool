                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?admin/task_manager/do_update/<?php echo $row['task_manager_id'] ?>" method="post" enctype="multipart/form-data">
					   ...
					   <div class="form-group">
                        <label for="field-1" class="col-sm-2 control-label"><?php echo get_phrase('task_name'); ?></label>
					...
					<div class="form-group">
                        <label for="field-ta" class="col-sm-2 control-label"><?php echo get_phrase('task_priority'); ?></label>
						...
						<option value="Low">Low</option>
                         ...
                         <div class="form-group">
                        <label for="field-1" class="col-sm-2 control-label"><?php echo get_phrase('task_date'); ?></label>
					...
					<div class="form-group">
                        <label for="field-ta" class="col-sm-2 control-label"><?php echo get_phrase('task_for'); ?></label>
            ...
            <optgroup label="<?php echo get_phrase('librarian'); ?>">
			 ...
			 <optgroup label="<?php echo get_phrase('hostel'); ?>">
                ...
                <?php endforeach; ?>
					...
					<div class="form-group">
                        <label for="field-ta" class="col-sm-2 control-label"><?php echo get_phrase('task_status'); ?></label>
                       ...
                       <div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<button type="submit" class="btn btn-blue btn-sm"><i class="entypo-pencil"></i><?php echo get_phrase('update_task_manager');?></button>
						</div>
					</div>
                    </form>
