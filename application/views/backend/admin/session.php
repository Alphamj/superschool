                    ...
                    <?php echo form_open(base_url() . 'index.php?admin/session/create', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <button type="submit" class="btn btn-blue btn-sm btn-icon icon-left"><i class="entypo-book"></i>&nbsp;<?php echo get_phrase('add_session'); ?></button>
                            </div>
                        </div>
                        </form> 
						<br>               
...
<div class="x_panel" >
    <div class="x_title">
        <div class="panel-title">
            <?php echo get_phrase('list_session'); ?>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        foreach ($sessions as $row):
                            ...
                            <tr>
                                ...
                                <td>
								<a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/modal_edit_session/<?php echo $row['session_id']; ?>');"><button type="button" class="btn btn-blue btn-xs"><i class="entypo-pencil"></i></button></a>
