...
<div class="x_panel" >
    <div class="x_title">
        <div class="panel-title">
			...
			<!--<a href="<?php echo base_url(); ?>index.php?admin/student_class/"><button type="button" class="btn btn-orange btn-xs"><i class="entypo-back"></i>Back</button></a>
			...
			<table class=" table" id="table_export">
                    <thead>
                        <tr>
                            ...
                            <th id="option_tds1"><div><?php echo get_phrase('options'); ?></div></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td id="option_tds">
									...
									<a href="<?php echo base_url(); ?>index.php?admin/view_student/<?php echo $row['student_id'];?>/"> <button type="button" class="btn btn-orange btn-xs"><i class="entypo-user"></i></button></a>
									...
									<a href="#" onclick="confirm_modal('<?php echo base_url(); ?>index.php?admin/student/<?php echo $class_id; ?>/delete/<?php echo $row['student_id']; ?>');"><button type="button" class="btn btn-red btn-xs"><i class="entypo-trash"></i></button></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
						...
						<table class=" table " id="table_export2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="span3"><div><?php echo get_phrase('address'); ?></div></th>
                                    <th><div><?php echo get_phrase('email'); ?></div></th>
                                    <th id="option_td1"><div><?php echo get_phrase('options'); ?></div></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function ($){
        ...
        $("#ToolTables_table_export_2").click(function(){
			console.log("fdfdf");
			$("#option_tds").remove();
			$("#option_tds1").remove();
		});
