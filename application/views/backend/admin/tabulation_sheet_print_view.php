...
?>
    ...
    <div class="row"><div class="col-md-12"><img src="uploads/logo.png" style="max-height:100px; display:block; margin-left:44.5%; padding:auto"></div>    
	 
		<div class="row" style="margin-left:30px;">	
			<div class="col-md-1">NAME:</div>
			<div class="col-md-8" style="padding-bottom: 10px; font-size: 20px"><?php echo $row['name'].' '.$row['surname'];;?></div>
			<div class="col-md-2">Class Attendance:</div>
			<div class="col-md-1">1234567</div>
		</div>
		   
		<div class="row" style="margin-left:30px">
			<div class="col-md-1">CLASS:</div>
			<div class="col-md-1"><?php $class_name = $this->db->get_where('class' , array('class_id' => $class_id))->row()->name;echo $class_name;?></div>
			<div class="col-md-7" style="text-align: center;font-size: 25px;font-family: 'canterburyregular';"><?php echo $this->db->get_where('settings' , array('type' =>'system_name'))->row()->description;?></div>
			<div class="col-md-2">TOTAL SCORE:</div>
			<div class="col-md-1">12345</div>
		</div>

		<div class="row" style="margin-left:30px">
			<div class="col-md-1">GENDER:</div>
			<div class="col-md-1 "><?php echo $sex;?></div>
			<div class="col-md-7" style="text-align: center;font-size: 20px;padding-bottom: 8px;"><?php echo $this->db->get_where('settings' , array('type' =>'address'))->row()->description;?></div>
			<div class="col-md-2">STUDENT AVERAGE SCORE:</div>
			<div class="col-md-1">12345</div>
		</div>

		<div class="row" style="margin-left:030px">
			<div class="col-md-1">DOB:</div>
			<div class="col-md-1 "><?php echo $birthday;?></div>
			<div class="col-md-7" style="text-align: center;font-size: 22px;">PROGRESS REPORT</div>
			<div class="col-md-2">CLASS AVERAGE:</div>
			<div class="col-md-1">12345</div>
		</div>

		<div class="row" style="margin-left:30px">
			<div class="col-md-1">ADMISSION NO:</div>
			<div class="col-md-1 "><?php echo $roll;?></div>
			<div class="col-md-7" style="text-align: center;font-size: 16px;"><?php  $exam_name = $this->db->get_where('exam' , array('exam_id' => $exam_id))->row()->name; echo $exam_name.' , '.$sessoin_id.' SESSION';?></div>
				...
				<?php 
				 ...
				 <?php }else if (strpos($class_type, 'primary') !== false){ ?>
					<div style="width: 71%;display: inline-block;vertical-align: top;">
							...
							<tr>
								<td colspan="13"></td>
								<td colspan="23" style="text-align: center;">TERM</td>
