...
<!----CREATION FORM STARTS---->
                	<?php echo form_open(base_url() . 'index.php?admin/hostel_room/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table " id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/hostel_room/delete/<?php echo $row['hostel_room_id'];?>');"><button type="button" class="btn btn-red btn-xs"><i class="entypo-trash"></i></button></a>
