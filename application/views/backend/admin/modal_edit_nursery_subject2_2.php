...
?>
	<div class="col-md-12">
		...
		<div class="panel-body">
            <?php echo form_open(base_url() . 'index.php?admin/nursery_subject2_2/do_update/'.$row['nursub_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
