...
td {font-family: Arial, sans-serif;font-size: 12px;padding: 8px;border: 1px solid #E6E9ED;border-width: 1px;overflow: hidden;word-break: normal;color: #000;}
 ...
 <div class="x_panel tablu" >
		...
		<?php 
			...
			echo form_open(base_url() . 'index.php?admin/tabulation_sheet');?>
			<div class="col-md-3">
...
<div class="row">
	...
	<!--COMMENT AREA-->
			...
			?>
					...
					<tr>
						<td style="width:45%"><?php echo $row['TeacherComment'];?></td>
						<td style="width:45%"><?php echo $row['HeadTeacherComment'];?></td>
					</tr>
				<?php endforeach; ?>
