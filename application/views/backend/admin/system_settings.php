        ...
        <div class="x_panel" >
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label  class="col-sm-2 control-label"><?php echo get_phrase('system_name'); ?></label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <label  class="col-sm-2 control-label"><?php echo get_phrase('system_title'); ?></label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <label  class="col-sm-2 control-label"><?php echo get_phrase('paypal_email'); ?></label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <label  class="col-sm-2 control-label"><?php echo get_phrase('system_email'); ?></label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <label  class="col-sm-2 control-label"><?php echo get_phrase('text_align'); ?></label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <label  class="col-sm-2 control-label"><?php echo get_phrase('running_session'); ?></label>
                    <div class="col-sm-10">
                        <select name="running_session" class="form-control ">
                            <option value="<?php echo $this->db->get_where('settings', array('type' => 'session'))->row()->description; ?>"><?php echo $this->db->get_where('settings', array('type' => 'session'))->row()->description; ?></option>
					...
					<div class="form-group">
                    <label  class="col-sm-2 control-label"><?php echo get_phrase('tawk_to_code'); ?></label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <label  class="col-sm-2 control-label"><?php echo get_phrase('system_footer'); ?></label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-blue btn-sm btn-icon icon-left"><i class="entypo-book"></i><?php echo get_phrase('save'); ?></button>
                    </div>
                </div>
                <?php echo form_close(); ?>
...
<?php echo get_phrase('upload_system_logo'); ?>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('Logo Image'); ?></label>
                        ...
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            ...
                            <div>
                                <span class="btn btn-white btn-file">
                                    <span class=" btn btn-orange fileinput-new">Browse Image</span>
...
<hr>
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9">
                        <button type="submit" class="btn btn-blue btn-sm btn-icon icon-left"><i class="entypo-book"></i><?php echo get_phrase('upload_system_logo'); ?></button>
                    </div>
                </div>
...
<?php echo form_close(); ?>
    ...
    <div class="col-md-12">
        ...
        <div class="x_panel" >
            ...
            <div class="x_title">
                <div class="panel-title">
                    <?php echo get_phrase('select_themes'); ?>
                </div>
            </div>
            ...
            <div class="panel-body">
                    ...
                    <div class="col-sm-2">
					 ...
					 <div class="col-sm-2">
                        <article class="album">
                            <header>
                                <a href="#" id="orange">
                                    <img src="assets/images/skins/orange.png"
                                         <?php if ($skin == 'yellow') echo 'style="background-color: black; opacity: 0.3;"'; ?> />
                                </a>
                ...
                <center>
                    <div class="alert alert-info" style="font-size: 30px;">
                      <?php echo get_phrase('click_to_change_theme'); ?>
                    </div>
                </center>
            </div>
