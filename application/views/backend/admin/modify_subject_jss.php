<div class="col-md-4">
 ...
 <!----CREATION FORM STARTS---->
                	...
                	<?php echo form_open(base_url() . 'index.php?admin/modify_subject_jss/display' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                         <div class="form-group">
                              <label class="col-sm-3 control-label"><?php echo 'Class';?></label>
                              <div class="col-sm-6">
                                   <select name="class_id" class="form-control"  onchange='this.form.submit()'  style="float:left;" required>
                                        <option value=""><?php echo get_phrase('select_a_class');?></option>
                                             <?php 
                                             $classes = $this->db->get('class')->result_array();
                                             foreach($classes as $row):
                                                  if ($row['class_id'] > 19 && $row['class_id'] < 29){
                                             ?>
...
<div class="col-md-8">
     <div class="x_panel table-responsive">
          ...
          <table class="table" id="table_export">
               ...
               <tbody>
                    <?php
                    $subject = $this->db->get_where('class_subject', array('class_id' => $class_id))->result_array();
                    ...
                    ?>
                         <tr>
                             ...
                             <td>
						     <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_modify_subject_jss/<?php echo $rows['subject_id'];?>/<?php echo $class_id;?>');"><button type="button" class="btn btn-blue btn-xs"><i class="entypo-pencil"></i></button></a>
						     <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/modify_subject_jss/delete/<?php echo $rows['subject_id'];?>/<?php echo $class_id;?>/<?php echo $student_id;?>');"><button type="button" class="btn btn-red btn-xs"><i class="entypo-trash"></i></button></a>
						</td>
                         </tr>
                    <?php endforeach;?>
