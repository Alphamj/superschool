						...
						?>
							<tr>
								...
								<td>
								 ...
								 <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/section_edit/<?php echo $row['section_id'];?>');"><button type="button" class="btn btn-blue btn-xs"><i class="entypo-pencil"></i></button></a>
				
                   
					 <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/sections/delete/<?php echo $row['section_id'];?>');"><button type="button" class="btn btn-red btn-xs" onclick="return confirm('Are you sure to delete?');"><i class="entypo-trash"></i></button></a>
