...
td {font-family: Arial, sans-serif;font-size: 12px;padding: 8px;border: 1px solid #E6E9ED;border-width: 1px;overflow: hidden;word-break: normal;color: #000;}
 ...
 <div class="x_panel tablu" >
		...
		<?php 
			...
			echo form_open(base_url() . 'index.php?admin/score_sheet0');?>
			<div class="col-md-3">
...
<!-- Nursery -->
		...
		<?php } ?>
		<center>
			<!-- <a href="<?php //echo base_url();?>index.php?admin/score_sheet0/<?php //echo $class_id;?>/<?php //echo $exam_id;?>/<?php //echo $sessoin_id;?>" 
