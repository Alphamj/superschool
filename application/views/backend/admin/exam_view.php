                        ...
                        foreach ($exam_data as $row):
                            ...
                            <tr>
                                ...
                                <td>
								 ...
								 <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>index.php?admin/exam_view/<?php echo $row['class_id'] . '/' . $row['subject_id'] . '/' . $row['duration'] . '/' . $row['date'] . '/' . ($row['session'] == '' ? '%null' : $row['session']) ?>/delete/<?php echo $row['question_id']; ?>');"><button type="button" class="btn btn-red btn-xs"><i class="entypo-cancel"></i></button></a>
								 
								 <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/exam_edit/<?php echo $row['question_id']; ?>');"><button type="button" class="btn btn-green btn-xs"><i class="entypo-pencil"></i></button></a>
