...
?>
	<div class="col-md-12">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/modify_subject/do_update/'.$row['subject_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            ...
                            <select name="class_ids" class="form-control"  style="float:left;" required>
                                        <option value=""><?php echo get_phrase('select_a_class');?></option>
                                             ...
                                             foreach($classes as $rows):
                                                  if ($rows['class_id'] > 28 && $rows['class_id'] < 40){
                                             ?>
