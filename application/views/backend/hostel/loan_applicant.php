    <?php echo form_open(base_url() . 'index.php?hostel/loan_applicant/create' , 
      array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
            ...
            <div class="x_panel" >
                ...
                <?php $hostel = $this->db->get_where('hostel', array('hostel_id' => $this->session->userdata('login_user_id')))->result_array();
				foreach ($hostel as $row):
   				?>
				<input type="hidden" class="form-control" name="staff_name" value="<?php echo $row['hostel_id'];?>" / required>
