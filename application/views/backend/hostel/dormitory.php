                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table " id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?hostel/dormitory/delete/<?php echo $row['dormitory_id'];?>');"><button type="button" class="btn btn-red btn-xs"><i class="entypo-trash"></i></button></a>
