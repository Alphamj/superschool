                ...
                foreach ($edit_data as $row):
                            ...
                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                ...
                                <div>
                                    <span class="btn btn-white btn-file">
                                        <span class="btn btn-orange fileinput-new">Select Image</span>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-blue btn-sm btn-icon icon-left"><i class="entypo-pencil"></i><?php echo get_phrase('update_profile'); ?></button>
                        </div>
                    </div>
                    <br>
                    </form>
        ...
        <div class="tab-pane box active" id="list" style="padding: 5px">
            <div class="box-content padded">
                ...
                foreach ($edit_data as $row):
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-blue btn-sm btn-icon icon-left"><i class="entypo-lock"></i><?php echo get_phrase('change_password'); ?></button>
                        </div>
                    </div>
                    <br>
                    </form>
