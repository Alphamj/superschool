    <?php echo form_open(base_url() . 'index.php?accountant/loan_applicant/create' , 
                ...
                <div class="panel-body">
		  			...
		  			<div class="form-group">
                        ...
                        <div class="col-sm-11">
							...
							<?php $classes = $this->db->get_where('accountant', array('accountant_id' => $this->session->userdata('login_user_id')))->result_array();
							foreach ($classes as $row):
    						?>
	                     <input type="hidden" class="form-control" name="staff_name" value="<?php echo $row['accountant_id'];?>" / required>
...
<hr>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-1 col-sm-11">
                        <button type="submit" class="btn btn-orange btn-sm btn-icon icon-left"><i class="entypo-plus"></i><?php echo get_phrase('save_now');?></button>
                    </div>
                  </div>
                    <?php echo form_close();?>
