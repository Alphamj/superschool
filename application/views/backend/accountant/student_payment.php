<div class="col-md-6">
        ...
        <div class="x_panel" >
				...
				<?php echo form_open(base_url() . 'index.php?accountant/invoice/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
							...
							<button type="submit" class="btn btn-green btn-sm btn-icon icon-left"><i class="entypo-plus"></i><?php echo get_phrase('generate_invoice');?></button>
                            </div>
                       		 </div>
        ...
        <div class="x_panel" >
				...
				<?php echo form_open(base_url() . 'index.php?accountant/invoice/create_mass_invoice' , array('class' => 'form-horizontal form-groups-bordered validate', 'id'=> 'mass' ,'target'=>'_top'));?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="method" class="form-control">
                                <option value="bank_payment"><?php echo get_phrase('bank_payment');?></option>
                    ...
                    <div class="form-group">
                        <div class="col-sm-5 col-sm-offset-3">
                                <button type="submit" class="btn btn-green btn-sm btn-icon icon-left"><i class="entypo-plus"></i><?php echo get_phrase('generate_mass_invoice');?></button>
                        </div>
                    </div>
