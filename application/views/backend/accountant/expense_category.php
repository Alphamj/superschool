        ...
        <tr>
            ...
            <td>
				...
				<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/expense_category_edit/<?php echo $row['expense_category_id'];?>');"><button type="button" class="btn btn-blue btn-xs"><i class="entypo-pencil"></i></button></a>
					...
					<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?accountant/expense_category/delete/<?php echo $row['expense_category_id'];?>');"><button type="button" class="btn btn-red btn-xs"><i class="entypo-trash"></i></button></a>
