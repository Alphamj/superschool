...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default panel-shadow" data-collapsed="0">
			<div class="x_title">
                <div class="panel-title"><?php echo get_phrase('accept_payment');?></div>
            </div>
            <div class="panel-body">
				<?php echo form_open(base_url() . 'index.php?admin/invoice/take_payment/'.$row['invoice_id'], array(
		            ...
		            <div class="form-group">
                           <div class="col-sm-5 col-sm-offset-3">
		                    <button type="submit" class="btn btn-success"><i class="entypo-book"></i><?php echo get_phrase('accept_payment');?></button>
		                </div>
		            </div>
