		...
		<table class=" table  datatable" >
                       <thead>
                        <tr>
                            ...
                            <td style="text-align: center;">C.A 1</td>
                            <td style="text-align: center;">CW</td>
							<td style="text-align: center;">C.A 2</td>
                            ...
                            <tr>
								...
								<?php
                                        ...
                                        if ( $obtained_mark_query->num_rows() > 0) {
                                            ...
                                            foreach ($marks as $row4) {
                                                ...
                                                $obtained_class_score = $row4['ca_1'];												
								...
								<?php
                                        ...
                                        if ( $obtained_mark_query->num_rows() > 0) {
                                            ...
                                            $obtained_class_score3 = $row4['ca_2'];												
								...
								<?php
                                        ...
                                        if ( $obtained_mark_query->num_rows() > 0) {
											...
											$obtained_class_score4 = $row4['project_score'];												
