        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo base_url(); ?>index.php?formtutor/examquestion/do_update/<?php echo $row['examquestion_id'] ?>" method="post" enctype="multipart/form-data">
