...
<button onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_study_material_add');" 
    class="btn btn-xs btn-orange">
        <i class="entypo-plus"></i> <?php echo get_phrase('add_material'); ?>
</button>
    ...
    <tbody>
        ...
        foreach ($study_material_info as $row) { ?>   
            <tr>
                ...
                <td>
                    <a href="<?php echo base_url().'uploads/document/'.$row['file_name']; ?>" class="btn btn-blue btn-xs">
                ...
                <td>
                    ...
                    <a href="<?php echo base_url();?>index.php?formtutor/study_material/delete/<?php echo $row['document_id']?>" 
