...
<h2><strong style="color:#FFFFFF"><?php echo $row ['name'].' '.$row ['surname'];?></strong></h2>
    ...
    <div class="col-md-12">
		...
		<table class=" table  datatable" >
                  ...
                  <?php 
					...
					?>
                    <a href="<?php echo base_url();?>index.php?formtutor/student_marksheet_print_view/<?php echo $row8['student_id'];?>/<?php echo $row2['exam_id'];?>" 
