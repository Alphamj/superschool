...
<?php echo form_open(base_url() . 'index.php?formtutor/message/send_reply/' . $current_message_thread_code, array('enctype' => 'multipart/form-data')); ?>
<div class="mail-reply">
	...
	<a href="<?php echo base_url(); ?>index.php?formtutor/message" class="btn btn-blue btn-sm ">
