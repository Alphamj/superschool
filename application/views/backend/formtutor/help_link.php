...
<table class="table table-bordered table-striped datatable" id="table-2">
                   ...
                   <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?formtutor/help_link/delete/<?php echo $row['helplink_id'];?>');"><button type="button" class="btn btn-xs btn-red"> <i class="entypo-cancel"></i></button></a>
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?formtutor/help_link/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
