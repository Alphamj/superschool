...
<div class="x_panel" >        
                <div class="x_title">
                    ...
                    foreach($edit_data as $row):
                        ?>
                        <?php echo form_open(base_url() . 'index.php?formtutor/manage_profile/update_profile_info' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
...
<div class="x_panel" >
                ...
                <div class="x_title">
                    ...
                    foreach($edit_data as $row):
                        ?>
                        <?php echo form_open('formtutor/manage_profile/change_password' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            <div class="form-group">
...
<button type="submit" class="btn btn-green btn-sm btn-icon icon-left"><i class="entypo-lock"></i><?php echo get_phrase('change_password');?></button>
                              </div>
								</div>
								<br>
                        </form>
