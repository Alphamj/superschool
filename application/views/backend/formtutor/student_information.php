...
<div class="x_panel" >
		...
		<?php echo form_open(base_url() . 'index.php?formtutor/student_information');?>
...
<div class="x_panel" >
    <div class="x_title">
        <div class="panel-title">
			...
			<!--<a href="<?php echo base_url(); ?>index.php?formtutor/student_class/"><button type="button" class="btn btn-orange btn-xs"><i class="entypo-back"></i>Back</button></a>
                      ...
                      if(isset($_REQUEST['student_search'])){
                        ...
                        foreach ($students as $row):
                            ...
                            <tr>
								...
								<a href="<?php echo base_url(); ?>index.php?formtutor/view_student/<?php echo $row['student_id'];?>/"> <button type="button" class="btn btn-orange btn-xs"><i class="entypo-user"></i></button></a>
                    ...
                    <tbody>
                        ...
                        foreach ($students as $row):
                            ...
                            <tr>
								...
								<!--<a href="<?php echo base_url(); ?>index.php?formtutor/student_marksheet/<?php echo $row['student_id']; ?>" target="_blank"><button type="button" class="btn btn-success btn-xs"><i class="entypo-chart-bar"></i></button></a>-->
								 
								 <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>index.php?formtutor/student/<?php echo $class_id; ?>/delete/<?php echo $row['student_id']; ?>');"><button type="button" class="btn btn-red btn-xs"><i class="entypo-trash"></i></button></a>
                    ...
                    <div class="tab-pane" id="<?php echo $row['section_id']; ?>">
						...
						<table class=" table " id="table_export2">
                            ...
                            <tbody>
								...
								<!--<a href="<?php echo base_url(); ?>index.php?formtutor/student_marksheet/<?php echo $row['student_id']; ?>"><button type="button" class="btn btn-success btn-xs"><i class="entypo-chart-bar"></i></button></a>-->
