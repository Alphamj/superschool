...
foreach ($edit_data as $row):
    ...
    <?php echo form_open(base_url() . 'index.php?formtutor/message/send_new/', array('class' => 'form', 'enctype' => 'multipart/form-data')); ?>
		...
		<br>
                    ...
                    <div class="form-group">
                        <label for="field-1" class="col-sm-2 control-label"><?php echo get_phrase('teacher_name'); ?></label>
					...
					<div class="col-sm-10">
					<textarea name="message" class="form-control" id="optimum-editor" placeholder= "Please type your new message here for the selected teacher to read."></textarea>
						</div>
						</div>
