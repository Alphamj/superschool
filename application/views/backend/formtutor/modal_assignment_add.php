...
<div class="x_panel" >
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(base_url().'index.php?formtutor/assignment/create' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
