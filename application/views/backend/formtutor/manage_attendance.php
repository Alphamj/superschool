...
<div class="row">
  <div class="x_title">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table">
		...
		<tbody>
        	<form method="post" action="<?php echo base_url();?>index.php?formtutor/attendance_selector" class="form">
            	<tr class="gradeA">
                    <td>
...
<div class="col-md-12">
        ...
        <div class="x_panel" >
        <form action="<?php echo base_url();?>index.php?formtutor/manage_attendance/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id;?>" method="post" accept-charset="utf-8">
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table">
        ...
        <center>
            <button type="submit" class="btn btn-green btn-sm btn-icon icon-left" id="submit_button"><i class="entypo-plus"></i> Add Attendance</button>
        </center>
        </form>
    </div>
</div>
