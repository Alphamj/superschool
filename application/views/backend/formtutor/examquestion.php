...
<table class="table table-bordered table-striped datatable" id="table-2">
    ...
    <tbody>
       <?php $a = $this->db->get_where('examquestion', array('teacher_id' => $this->session->userdata('login_user_id')))->result_array();
				 foreach ($a as $row):
				 ?>
            <tr>
			...
			<td>
                ...
                <td>
                    ...
                    <a href="<?php echo base_url();?>index.php?formtutor/examquestion/delete/<?php echo $row['examquestion_id']?>" 
