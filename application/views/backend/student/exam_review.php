            ...
            success: function (result_list)
            {
                ...
                for (var i = 0; i < result_list.length; i++) {
                    htmltext += '<tr>' +
                            ...
                            '<td><div><button class="btn btn-green btn-xs" onclick="viewDetail(\'' + result_list[i]["class_id"] + '\',\'' + result_list[i]["subject_id"] + '\',\'' + result_list[i]["student_id"] + '\',\'' + result_list[i]["duration"] + '\',\'' + result_list[i]["session"] + '\',\'' + result_list[i]["date"] + '\')"><?php echo get_phrase('view_detail') ?></button></div></td>' +
                            '</tr>';
                }
