...
<a href="<?php echo base_url(); ?>index.php?student/message/message_new" class="btn btn-green btn-sm "> <i class="entypo-pencil"></i>
...
<table class="table" id="table-2">
                ...
                ?>
					...
					<td><a href="<?php echo base_url(); ?>index.php?student/message/message_read/<?php echo $row['message_thread_code']; ?>"><button type="button" class="btn btn-orange btn-xs"><i class="entypo-mail"></i>Read Message</button></a>
					</td>
					<td>  <a href="<?php echo base_url(); ?>index.php?student/message/message_read/<?php echo $row['message_thread_code']; ?>"><button type="button" class="btn btn-blue btn-xs"><i class="entypo-reply"></i></button></a></td>
					</tr>
		  <?php endforeach; ?>
                    </tbody>
                </table>
