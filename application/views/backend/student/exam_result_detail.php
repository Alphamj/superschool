        <!------CONTROL TABS START------>
             <div class="x_panel" >
                <div class="x_title">
                    ...
                    <?php echo $detail_list[0]['class'] ?> | <?php echo $detail_list[0]['student'] ?> | <?php echo $detail_list[0]['subject'] ?> | <?php echo $detail_list[0]['date'] ?> <?php echo get_phrase('exam_result'); ?>
                </a>
            </div>
			</div>
        <!------CONTROL TABS END------>
