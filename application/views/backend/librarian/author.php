...
<div class="x_title">
   ...
   <!----CREATION FORM STARTS---->
                    ...
                    <?php echo form_open(base_url() . 'index.php?librarian/author/create', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
                        ...
                        foreach ($authors as $row):
                            ...
                            <tr>
                                ...
                                <td>
								 ...
								 <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>index.php?librarian/author/delete/<?php echo $row['author_id']; ?>');">
