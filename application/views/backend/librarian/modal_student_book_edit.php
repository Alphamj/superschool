    ...
    ?>
		...
		<img src="<?php echo $this->crud_model->get_image_url('student' , $row['student_id']);?>" class="img-circle" width="100" height="100" />
                ...
                <div class="panel-body">
                    ...
                    <?php echo form_open(base_url() . 'index.php?librarian/student/' . $row['class_id'] . '/edit_book/' . $row['student_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
