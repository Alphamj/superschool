...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
        ...
        <title><?php echo get_phrase('news_content'); ?> | <?php echo $system_title; ?></title>
		 <!-- Bootstrap core CSS -->
    ...
    <!--Banner Wrap End-->
        ...
        <div class="container">
            <div class="ct_related_blog">
                <h4 align="center" style="color:#006600"><?php $system_name = $this->db->get_where('settings', array('type' => 'system_name'))->row()->description;
?> <?php echo $system_name; ?>&nbsp;EVENT GALLERIES</h4>
<div align="center"><img src="landing/images/hdg-01.png" alt=""></div>
<hr>
                <div class="row">
                	<?php 
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="ct_course_list_wrap">
                           <figure>
            					<img src="<?php echo base_url(); ?>uploads/gallery_image/<?php echo $row['file_name'];?>" width="260" height="260" llargewidth="260" largeheight="360" alt="">
